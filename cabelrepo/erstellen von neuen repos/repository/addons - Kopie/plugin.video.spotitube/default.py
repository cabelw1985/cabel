...
def run():
	...
	if mode == 'root': ##### Delete complete old Userdata-Folder to cleanup old Entries #####
		...
		navigator.listDeezerArtists(url) 
	elif mode == 'listDeezerTracks':
		navigator.listDeezerTracks(url) 
	elif mode == 'listDeezerAlbums':
		navigator.listDeezerAlbums(url)
	elif mode == 'listDeezerPlaylists':
		navigator.listDeezerPlaylists(url)
	elif mode == 'listDeezerUserlists':
		navigator.listDeezerUserlists(url)
	elif mode == 'listDeezerVideos':
		navigator.listDeezerVideos(url, type, limit, extras)
	elif mode == 'playYTByTitle':
		navigator.playYTByTitle(url)
