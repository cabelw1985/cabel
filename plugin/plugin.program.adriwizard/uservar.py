...
#        User Edit Variables                            #
#########################################################
ADDONTITLE = '[COLOR darkcyan]AdriKodi [/COLOR]All In One Wizard'
BUILDERNAME = 'Adri Kodi Wizard'
EXCLUDES = [ADDON_ID, 'plugin.program.adriwizard']
# Text File with build info in it.
BUILDFILE = 'http://adri-kodi.com/KodiLeiaPro/autobuildsnew.txt'
...
THEME1 = u'[COLOR {color1}][I]([COLOR {color1}][B]Adri[/B][/COLOR][COLOR {color2}]All In One Wizard[COLOR {color1}])[/I][/COLOR] [COLOR {color2}]{{}}[/COLOR]'.format(color1=COLOR1, color2=COLOR2)
...
HIDECONTACT = 'No'
# You can add \n to do line breaks
CONTACT = 'Thank you for choosing The Adri Kodi All In One Wizard.'
...
REPOID = 'plugin.program.adriwizard'
...
# Font size of header
FONTHEADER = 'Font14'
HEADERMESSAGE = '[COLOR darkcyan]Adri [/COLOR]All In One Wizard'
